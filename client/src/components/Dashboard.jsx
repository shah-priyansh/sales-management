...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setRecentData({
        salesmen: response.data.recentSalesmen || [],
        clients: response.data.recentClients || []
      });
    } catch (error) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          ...
          <div className="space-y-2">
            {recentData.salesmen.length > 0 ? (
              recentData.salesmen.map((salesman, index) => (
                <RecentItem
                  key={salesman._id}
        ...
        <div className="card">
          ...
          <div className="space-y-2">
            {recentData.clients.length > 0 ? (
              recentData.clients.map((client, index) => (
                <RecentItem
                  key={client._id}
                  title={client.name}
